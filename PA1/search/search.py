...
def pathGenerator(from_arr, to_arr, action_arr, start, dest):
    path = []
    cur = dest
    while not cur == start:
        # print(cur)
        index = to_arr.index(cur)
        cur = from_arr[index]
        # print(cur)
    ...
    while not frontier.isEmpty():
        ...
        if cur not in explored:
            ...
            for successor, action, cost in successors:
                ...
                from_arr.append(cur)
                to_arr.append(successor)
                action_arr.append(action)
    path = pathGenerator(from_arr, to_arr, action_arr, start, dest)
    return path
    ...
    while not frontier.isEmpty():
        ...
        if cur_state not in explored:
            ...
            for successor, action, cost in successors:
                ...
                frontier.push((successor, new_path, new_cost), new_heuristic_cost)
